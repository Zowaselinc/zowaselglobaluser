<template>
    <div class="top-nav">
        ...
        <div class="right-btns">
            <button class="logistic">Logistics</button>
...
.right-btns {
    ...
    .logistic {
        ...
        width: 132.22px;
        height: 45.33px;
        border: 1.88889px solid #05B050;
        color: #05B050;
        box-shadow: 0px 1.88889px 3.77778px rgba(44, 39, 56, 0.08), 0px 3.77778px 7.55556px rgba(44, 39, 56, 0.08);
