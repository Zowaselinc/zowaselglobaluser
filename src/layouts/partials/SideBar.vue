<template>
    ...
    <nav id="sidebarMenu" class="collapse d-md-block">
        <div id="side-menu" class="list-group list-group-flush">
            <a href="#" class="nav-item" aria-current="true">
                <div class="ripple">
            ...
            <a href="#" class="nav-item">
                <div class="ripple">
                    ...
                    <span>Wallet</span>
                    <img class="arrow-symbol" src="@/assets/images/vectors/arrowSymbol.svg" alt="Arrow-Symbol">
            ...
            <a href="#" class="nav-item">
                <div class="ripple">
                    <img class="img-fluid" src="@/assets/images/vectors/marketPlace.svg" alt="Credit Scoring"><span>Credit
                    Scoring</span>
                <img class="arrow-symbol" src="@/assets/images/vectors/arrowSymbol.svg" alt="Arrow-Symbol">
                <img class="arrow-symbol carretUp" src="@/assets/images/vectors/arrowupsymbol.svg" alt="Arrow-Symbol">
                </div>
