<template>
  ...
  <nav id="sidebarMenu" class="collapse d-md-block">
    <div id="side-menu" class="list-group list-group-flush position-relative">
      ...
      <a href="/dashboard/messages" class="nav-item">
        <div :class="['ripple', 'active-item', isRouteActive('/dashboard/messages')]">
          <img class="img-fluid" src="@/assets/images/vectors/ChatText.svg" alt="ChatText"><span>Message</span>
        </div>
      </a>
      <a href="javascript:void(0)" class="nav-item">
        <div :class="['ripple', 'accordion-header', isRouteActive('/dashboard/marketplace')]">
          <img class="img-fluid" src="@/assets/images/vectors/Storefront.svg" alt="marketplace"><span>Marketplace</span>
          <img class="arrow-symbol carret-down" src="@/assets/images/vectors/arrowSymbol.svg" alt="Arrow-Symbol">
          <img class="arrow-symbol carretUp" src="@/assets/images/vectors/arrowupsymbol.svg" alt="Arrow-Symbol">
        </div>
        <!-- drop menu -->
      ...
      <a href="/dashboard/negotiations" class="nav-item">
        <div :class="['ripple', 'active-item', isRouteActive('/dashboard/negotiations')]">
          <img class="img-fluid" src="@/assets/images/vectors/ChatText.svg" alt="ChatText"><span>Negotiations</span>
        </div>
      </a>
      <a href="javascript:void(0)" class="nav-item">
      ...
      <a href="/dashboard/settings" class="nav-item">
        <div :class="['ripple', 'active-item', isRouteActive('/dashboard/settings')]">
          <img class="img-fluid" src="@/assets/images/vectors/GearSixBold.svg" alt="settings"><span>Settings</span>
        </div>
    ...
    <a href="javascript:void(0)" class="nav-item">
      ...
      <div class="drop-menu marketplace-menu">
        <template v-if="userData.user.type == 'corporate'">
          <div class="active-item" @click="changeDir('/dashboard/marketplace/cropsale')">
            Crops for Sale
          </div>
          <div class="active-item" @click="changeDir('/dashboard/marketplace/cropauction')">
            Crops for auction
          </div>
        </template>
        <template v-if="userData.user.type == 'merchant'">
          <div class="active-item" @click="changeDir('/dashboard/marketplace/cropwanted')">
            Crops Wanted
          </div>
          <div class="active-item" @click="changeDir('/dashboard/marketplace/inputs')">
            Input Market
          </div>
        </template>
      </div>
    ...
    <a href="javascript:void(0)" class="nav-item">
      <div :class="[
        ...
        <img class="side-bar-icon img-fluid" src="@/assets/images/vectors/marketPlace.svg"
          alt="Credit Scoring" /><span>Credit Scoring</span>
        <img class="arrow-symbol carret-down" src="@/assets/images/vectors/arrowSymbol.svg" alt="Arrow-Symbol" />
        <img class="arrow-symbol carretUp" src="@/assets/images/vectors/arrowupsymbol.svg" alt="Arrow-Symbol" />
      </div>
      <!-- drop menu -->
      <div class="drop-menu scoring-menu">
        <div class="active-menu" @click="changeDir(' /dashboard/creditscoringpointsystem')">
          Credit score point system
        </div>
        <div class="active-menu" @click="changeDir(' /dashboard/creditscoreanalysis')">
          credit score analysis
        </div>
        <div class="active-menu" @click="changeDir(' /dashboard/loan')">
          Loans
        </div>
        <div class="active-menu" @click="changeDir(' /dashboard/scoreanalysis')">
          Score Analysis
        </div>
      </div>
    </a>
    ...
    <a href="javascript:void(0)" class="nav-item">
      ...
      <!-- drop menu -->
      <div class="drop-menu api-menu">
        <div class="active-menu" @click="changeDir(' /dashboard/subscription')">
          service subscription
        </div>
        <div class="active-menu" @click="changeDir('/dashboard/renewalmanager')">
          Renewal manager
        </div>
        <div class="active-menu">Traffic & usage stats</div>
        <div class="active-menu">Changelog notification</div>
