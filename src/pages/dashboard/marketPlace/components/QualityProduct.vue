    ...
    <div class="main_container">
        ...
        <div class="crop-wanted-section d-flex flex-row gap-4">
            <form>
                ...
                <div class="crop_details mb-5">Delivery Details</div>
                <div class="w-100 mb-3">
            ...
            <form>
                ...
                <div class="dropzone_conatiner mb-4">
                    <div class="dropzone" id="my-dropzone">
                        <img src="@/assets/images/vectors/Image.svg" alt="image">
                        <div>  Drop your images here, or select <span>click to browse</span></div>
                    </div>
                    <input type="file" id="file-input" multiple>
                </div>
                <div class="dropzone_conatiner d-flex flex-row gap-3 mb-4">
                    <div class="drop_zone_1">
