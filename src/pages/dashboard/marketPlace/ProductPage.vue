        ...
        <div class="big-container">
            <div class="big-content" v-if="product">
                ...
                <div class="topic" v-if="product">
                    <div class="left">
                        <h1>{{ product.title }}</h1>
                        <p class="price">{{ product.currency }}{{ product.specification.price }}/{{ product.packaging }}
                        </p>
                        <p class="farmer">{{ product.user.first_name + " " + product.user.last_name }} <span> <img
                                    src="@/assets/images/vectors/verified.svg" alt=""> Verified merchant</span></p>
                    </div>
                    <!-- <div v-if="(product.images.length > 1)" class="small-images">
                    <img v-for="image,index in product.images.slice(1)" :key="index" :src="image" alt="">
                </div> -->
