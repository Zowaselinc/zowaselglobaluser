<template>
  <div class="full-spec-wrapper">
    <h2>Standard Quality Specification (SQS)</h2>
    <table class="table table-SQS table-bordered">
      <thead>
        <tr>
          <th>Parameters</th>
          <th>
            <span id="parameters" class="d-block">Specification</span>(Dropdown
            Menu)
          </th>
        </tr>
      </thead>
      <tbody>
        ...
        <tr>
          ...
          <td>
            {{
              placeString(order.products[0].specification.foreign_matter, "-", {
                suffix: "%",
              })
            }}
          </td>
        ...
        <tr>
          ...
          <td>
            {{
              placeString(order.products[0].specification.broken_grains, "-", {
                suffix: "%",
              })
            }}
          </td>
        ...
        <tr>
          <td>Test weight</td>
          <td>{{ placeString(order.products[0].specification.unit, "-") }}</td>
        </tr>
        <tr>
          <td>Hardness</td>
          <td>
        ...
        <tr>
          ...
          <td>
            {{
              placeString(order.products[0].specification.total_defects, "-", {
                suffix: "%",
              })
            }}
          </td>
    ...
    <div class="btn-group w-100 gap-4">
      <a href="" class="btn" type="button">Download</a>
      <a href="" class="btn" type="button">Print</a>
    </div>
  </div>
</template>
